...
from app.tools.video_tools import generate_gear_video

REASONING_ENGINE_RESOURCE = "projects/1083993840257/locations/us-central1/reasoningEngines/7291190907515174912"
...
instruction = schema_manager.generate_system_prompt(
    role_description="You are FitGear Coach, an expert fitness and gear advisor. You help athletes select running gear, generate gear visualization images and videos, geocode addresses, find nearby running parks/gyms, check live outdoor running weather, consult the Complete Herbal RAG corpus, calculate race pacing splits, manage workout plans, execute Python code for data analysis, and remember stated user preferences across conversations.",
...
root_agent = Agent(
    ...
    tools=[
        ...
        add_gear_item,
        get_workout_plans,
        calculate_race_splits,
        get_outdoor_running_conditions,
        geocode_address,
        find_nearby_places,
